...
<h1 align=center style="color:white"><u>Track Order</u></h1><br><br>
<center>
...
<td style="padding:5px;width:14%;white-space:pre-wrap;word-wrap:break-word"><font color=white size=5>Product Name</font></td>
<td style="padding:5px;width:14%;white-space:pre-wrap;word-wrap:break-word"><font color=white size=5>Product Brand</font></td>
<td style="padding:5px;width:11%;white-space:pre-wrap;word-wrap:break-word"><font color=white size=5>Product Colour</font></td>
<td style="padding:5px;width:9%;white-space:pre-wrap;word-wrap:break-word"><font color=white size=5>Product Size</font></td>
<td style="padding:5px;width:23%;white-space:pre-wrap;word-wrap:break-word"><font color=white size=5>Product Description</font></td>
...
$query="select * from orders where bid='".$_GET['del']."'";
...
while($r=mysql_fetch_array($result))
{
	...
	echo '<ul style="width:1100px">
			...
			<td style="padding:5px;width:14%;white-space:pre-wrap;word-wrap:break-word"><a href="productdetails.php?id='.$pid.'"><font color=white size=4>'.$pname.'</font></a></td>
			<td style="padding:5px;width:14%;white-space:pre-wrap;word-wrap:break-word"><a href="productdetails.php?id='.$pid.'"><font color=white size=4>'.$pbrand.'</font></a></td>
			<td style="padding:5px;width:11%;white-space:pre-wrap;word-wrap:break-word"><a href="productdetails.php?id='.$pid.'"><font color=white size=4>'.$pcolour.'</font></a></td>
			...
			<td style="padding:5px;width:23%;white-space:pre-wrap;word-wrap:break-word"><a href="productdetails.php?id='.$pid.'"><font color=white size=4>'.$pdescription.'</font></a></td>
...
echo '<h2 align=center style="color:white"><u>Tracking Status</u></h2>
		<table border=5>
		<tr><td bgcolor='.$ord.' style="padding:20px 50px">ORDER RECEIVED</td>
			<td bgcolor='.$pack.' style="padding:20px 50px">PACKED BY SELLER</td>
			<td bgcolor='.$ship.' style="padding:20px 50px">SHIPPED</td>
			<td bgcolor='.$deli.' style="padding:20px 50px">DELIVERED</td></tr>
		</table>';
