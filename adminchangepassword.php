...
$query="select * from adminid where id='$login_id'";
$query1="select pw from adminid where id='$login_id'";
...
if(isset($_POST['sub']))
{
	...
	if($pwd!=$opw)
	{
		$msg="<font size=6 color=#ff99cc><b>Old Password Not Match!!!!</b><br><br><br></font>";
	}
	elseif($opw==$npw)
	{
	...
	{
		$query2="update adminid set pw='$npw' WHERE id='$login_id'";
...
<font color=white size=4>Old Password :</font><br><input type=password placeholder="Enter Your Password" name=opw><br><br><br><br>
<font color=white size=4>New Password :</font><br><input type=password placeholder="Enter Your Password" id=nwpw name=npw><br><br><br><br>
<font color=white size=4>Confirm Password :</font><br><input type=password OnInput=pwcheck() placeholder="Enter Your Password" id=cfpw name=cpw><br><br></div>
