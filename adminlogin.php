...
else
{
	...
	if(isset($_POST['sub']))
	{
		$un=$_POST['un'];
		$pwd=$_POST['pwd'];
		$query="select * from adminid where id='$un'";
		$result=mysql_query($query);
		$nor=mysql_num_rows($result);
		if($nor==0)
			$msg="<font size=6 color=#ff99cc><b>ID Does Not Exist!!!!</b><br><br><br></font>";
		else
		{
...
<html>
<head>
<title>Craft Clothing - Be Stylish | Admin Log In</title>
...
<center>
<h1><font color=white><u>Admin Login</u></font></h1><br><br><br>
...
<font color=white size=4>Password :</font><br><input type=Password placeholder="Enter Your Password" name=pwd required><br><br><br><br></div>
