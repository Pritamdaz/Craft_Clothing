...
$query1="select pw from account where email='$login_email'";
...
if(isset($_POST['sub']))
{
	...
	if($pwd!=$opw)
	{
		$msg="<font size=6 color=#ff99cc><b>Old Password Not Matched!!!!</b><br><br><br></font>";
	}
	elseif($opw==$npw)
	{
		$msg="<font size=6 color=#ff99cc><b>Old Password Same With New Password!!!!</b><br><br><br></font>";
	}
	elseif($npw!=$cpw)
	{
	...
	{
		$query2="update account set pw='$npw' where email='$login_email'";
...
<html>
<head>
<title>Craft Clothing - Be Stylish | Change Password</title>
...
<center>
<h1><font color=white><u>Change Password</u></font></h1><br><br><br>
<form name=f1 method="post" action="">
<?php echo $msg; ?>
<font color=white size=4>Old Password :</font> <input type=password placeholder="Enter Your Password" name=opw><br><br><br><br>
<font color=white size=4>New Password :</font> <input type=password placeholder="Enter Your Password" id=nwpw name=npw><br><br><br><br>
<font color=white size=4>Confirm Password :</font> <input type=password OnInput=pwcheck() placeholder="Enter Your Password" id=cfpw name=cpw><br><br>
<span id=msg></span><br><br><br>
<input class=button1 type=submit value="Change Password" name=sub>
</form>
</center>
