...
// if everything is ok, try to upload file
 ...
 $sql="insert into products(subcat,pname,pprice,pcolour,pbrand,psize,pdescription,image) values ('".$_POST['subcateg']."','".strtoupper($_POST['proname'])."','".$_POST['proprice']."','".strtoupper($_POST['procolour'])."','".strtoupper($_POST['probrand'])."','".strtoupper($_POST['prosize'])."','".$_POST['prodesc']."','".$new."')";
...
else { header('Location:adminpanel.php?msg'); }
}
?>